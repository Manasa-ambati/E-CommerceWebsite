  ...
  return (
    ...
    <div className={`mobile-menu-overlay ${mobileMenuOpen ? 'open' : ''}`}>
      <div className="mobile-menu-content">
        ...
        {/* MOBILE NAVIGATION LINKS - Conditionally show based on auth */}
        <div className="mobile-nav-links">
          {isLoggedIn ? (
            // Show all nav links when logged in
            <>
            ...
            // Hide nav links when not logged in - they'll see auth buttons instead
            <></>
          )}
        </div>
